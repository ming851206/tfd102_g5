...
CREATE TABLE `member` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb3 COMMENT='會員';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `member` VALUES (1,'阿土伯','abei','1111','1988-01-01','0917479111','1',1,1,'19990101'),(2,'孫小美','mei','1111','1988-01-01','0917479112','2',2,1,'19990101'),(3,'宮本寶藏','jp123','1111','1988-01-01','0917479113','3',1,1,'19990101'),(4,'莎拉公主','sala','1111','1988-01-01','0917479114','4',1,1,'19990101'),(5,'錢夫人','madam','1111','1988-01-01','0917479115','5',1,1,'19990101'),(6,'嗚咪','wumi','1111','1988-01-01','0917479116','6',1,1,'19990101'),(7,'小丹尼','danny','1111','1988-01-01','0917479117','7',1,1,'19990101'),(8,'詹姆士','james','1111','1988-01-01','0917479117','7',1,1,'19990101'),(9,'糖糖','candy','1111','1988-01-01','0917479117','7',1,1,'19990101'),(10,'忍太郎','nijia','1111','1988-01-01','0917479117','7',1,1,'19990101'),(11,'金凱子','kai','1111','1988-01-01','0917479117','7',1,1,'19990101'),(12,'愛麗絲','alice','1111','1988-01-01','0917479117','7',1,1,'19990101'),(13,'DDR','ddr','1111','1988-01-01','0917479117','7',1,1,'19990101'),(14,'奇奇','kiki','1111','1988-01-01','0917479117','7',1,1,'19990101'),(15,'史密斯','smith','1111','1988-01-01','0917479117','7',1,1,'19990101'),(16,'星期三','wed','1111','1988-01-01','0917479117','7',1,1,'19990101');
...
INSERT INTO `qa_list` VALUES (2,1,'自由女神像是哪個國家送給美國的禮物?\n','法國','德國','英國',1),(3,1,'請問夏威夷是屬於哪一洲？\n','美洲','大洋洲','澳洲',2),(4,1,'美國國旗共有幾個星星？\n','50','51','52',1),(5,1,'哪一個國家四季都要喝冰水？','墨西哥','美國','希臘',2),(6,1,'請問在美國哪一個食物，一年所消耗的雞肉佔了80億隻雞？\n\n','炸雞','漢堡','雞塊',3),(7,1,'華盛頓和中國哪一任皇帝是同一年去世的?\n','康熙','乾隆','雍正',1),(8,2,'請問哪個國家是世界上肥胖率最高的國家？\n','美國','英國','德國',2),(9,2,'請問哪一個國家光溜溜走在路上是合法的，不需要 忌諱，做自己？','法國','西班牙 ','葡萄牙',2),(10,2,'下列何者景點不是在歐洲境內?\n','羅浮宮','凱旋門','自由女神像',3),(11,2,'擁有全世界最多的諾北爾文學獎得主的國家是？\n','義大利','法國','英國',2),(12,2,'在哪個國家說早安，會被認為是很煩的行爲\n','德國','英國','比利時',2),(13,2,'在法國大革命之後歷經了數任國王，\n在位期間都很短，請問最短在位時間為？\n','20 分鐘','1 天','3 小時',1),(14,3,'日本哪個地方是連小強都『強』不起來的地方？','京都','北海道','函館',2),(15,3,'韓國人的幸運數字是？\n','一','二','三',3),(16,3,'在韓國，祝賀搬新家的禮物是？\n','碗筷','毛巾','捲筒衛生紙',3),(17,3,'在印度，有哪項行為不適合公共場合做，嚴重可能會判公共猥褻罪？\n','親吻','比 ok','剔牙',1),(18,3,'下列城市何者不是在馬來西亞內?\n','東京','吉隆坡','檳城',1),(19,3,'下列何者為印度的世界遺產?','吳哥窟','大堡礁','泰姬瑪哈陵',3),(20,4,'在非洲，吃的人最多的動物是什麼？\n','河馬','獅子','鱷魚',1),(21,4,'世界上雙胞胎最多的地方在哪裡？\n','印度','奈及利亞','美國',2),(22,4,'誰說企鵝只生活在南極，請問下列哪個地方也有企鵝？\n','南非','俄羅斯','南亞',1),(23,4,'下列何者不是在非洲內?\n','埃及','日本','衣索比亞',2),(24,4,'下列何者景點不在非洲境內?\n','艾菲爾鐵塔','埃及金字塔','爾塔阿雷火山',1),(25,4,'電影『獅子王』中，彭彭與丁滿唱的「Hakuna Matata」，他是非洲語的什麼意思呢？\n','不用擔心','明天會更好','活在當下',1),(26,5,'請問澳洲屬於哪一洲？\n','澳洲','大洋洲','亞洲',2),(27,5,'請問澳洲首都是？\n','坎培拉','雪梨','墨爾本',1),(28,5,'下列哪個不在大洋洲內?\n','澳洲','台灣','紐西蘭',2),(29,5,'下列何者不是帛琉的著名景點之一?\n','牛奶湖','牛奶湖','玫瑰湖',3),(30,5,'在紐西蘭，以下哪一個話題千萬不要拿來開玩笑？\n','電影魔戒','足球','首相',1),(31,5,'在以下哪個國家，牛奶比水還要便宜？\n','紐西蘭','澳洲','印尼',2);
...
-- Dump completed on 2021-08-01  2:07:05
